...
class SerperSearch:
    def __init__(self)->None:
        self.api_key=os.getenv("SERPER_API_KEY_3")
...
if __name__=="__main__":
    ...
    # print(serper_search.serper_keyword_search("中医舌诊"))
    # print(serper_search.serper_webpage_scraping(["https://www.baidu.com"]))
    print(serper_search.serper_image_search(["中医","中药材","穴位"]))
    # print(serper_search.serper_search(["中医","中药材","穴位"]))